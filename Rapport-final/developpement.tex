...
Une fois Scratchbox installé, on a dut créer la machine virtuelle pour effectuer la cross-compilation.
...
La fonction ioctl générique prenant cette commande sous la forme d'un entier, l'intégralité des commandes utilisées ici sont disponibles dans le fichier fbutils.h. %todo : a mettre en annex ?

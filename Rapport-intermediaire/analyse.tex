...
Il intègre aussi la technology NEON permettant de meilleurs performance graphique (dans le cas de la liseuse on notera une augmentation de la rapidité pour tourner les pages par exemple).
